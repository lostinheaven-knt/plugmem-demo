...
def test_retrieve_structured_returns_answer_object(tmp_path: Path) -> None:
    ...
    ans = plugmem.retrieve_structured(query="What should I do to find the cheapest wireless mouse?")
